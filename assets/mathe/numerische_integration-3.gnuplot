...
set output 'numerische_integration-3.svg'

set object 1 rectangle fillstyle transparent solid 0

set title "numerische Integration - Trapezmethode"
...
set arrow from -4, f(-4) to -3, f(-3) nohead
set arrow from -3, graph 0 to -3, f(-3) nohead
set arrow from -3, f(-3) to -2, f(-2) nohead
set arrow from -2, graph 0 to -2, f(-2) nohead
set arrow from -2, f(-2) to -1, f(-1) nohead
set arrow from -1, graph 0 to -1, f(-1) nohead
set arrow from -1, f(-1) to 0, f(0) nohead
set arrow from 0, graph 0 to 0, f(0) nohead
set arrow from 0, f(0) to 1, f(1) nohead
set arrow from 1, graph 0 to 1, f(1) nohead
set arrow from 1, f(1) to 2, f(2) nohead
set arrow from 2, graph 0 to 2, f(2) nohead
set arrow from 2, f(2) to 3, f(3) nohead
set arrow from 3, graph 0 to 3, f(3) nohead
